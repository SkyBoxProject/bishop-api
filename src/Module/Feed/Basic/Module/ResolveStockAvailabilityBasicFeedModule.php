...
final class ResolveStockAvailabilityBasicFeedModule implements ResolveNameModuleInterface
{
    ...
    {
        $rawProduct->attributes()->{self::AVAILABLE}->__toString() === 'true' ? $product->markAsStockAvailability() : $product->unmarkAsStockAvailability();
    }
}
